...
describe("Collections", () => {
    ...
    test("list (2)", async () => {
        ...
        await expect(async () => {
            return await client.collections.list("site_id");
    ...
    test("create (2)", async () => {
        ...
        const rawRequestBody = { displayName: "displayName", singularName: "singularName" };
        const rawResponseBody = { key: "value" };
        server
            .mockEndpoint()
        ...
        await expect(async () => {
            return await client.collections.create("site_id", {

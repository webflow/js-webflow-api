...
describe("Scripts", () => {
    ...
    test("get-custom-code (2)", async () => {
        ...
        await expect(async () => {
            return await client.sites.scripts.getCustomCode("site_id");
    ...
    test("upsert-custom-code (2)", async () => {
        ...
        await expect(async () => {
            return await client.sites.scripts.upsertCustomCode("site_id", {});
        }).rejects.toThrow(Webflow.BadRequestError);
    });
    ...
    test("delete-custom-code (2)", async () => {
        ...
        server
            .mockEndpoint()
            .delete("/sites/site_id/custom_code")
            .respondWith()
            .statusCode(400)
            .jsonBody(rawResponseBody)
            .build();
        ...
        await expect(async () => {
            return await client.sites.scripts.deleteCustomCode("site_id");
        }).rejects.toThrow(Webflow.BadRequestError);
    });
    ...
    test("list-custom-code-blocks (1)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
    ...
    test("list-custom-code-blocks (2)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
        ...
        server
            .mockEndpoint()
            .get("/sites/site_id/custom_code/blocks")
            .respondWith()
            .statusCode(400)
            .jsonBody(rawResponseBody)
            .build();
        ...
        await expect(async () => {
            return await client.sites.scripts.listCustomCodeBlocks("site_id");
        }).rejects.toThrow(Webflow.BadRequestError);
    });

    test("list-custom-code-blocks (3)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
    ...
    test("list-custom-code-blocks (4)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
    ...
    test("list-custom-code-blocks (5)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
    ...
    test("list-custom-code-blocks (6)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },

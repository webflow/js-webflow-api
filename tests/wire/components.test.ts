...
describe("Components", () => {
    ...
    test("list (2)", async () => {
        ...
        await expect(async () => {
            return await client.components.list("site_id");
    ...
    test("get-content (2)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/sites/site_id/components/component_id/dom")
            .respondWith()
            .statusCode(400)
            .jsonBody(rawResponseBody)
            .build();
        ...
        await expect(async () => {
            return await client.components.getContent("site_id", "component_id");
        }).rejects.toThrow(Webflow.BadRequestError);
    });
    ...
    test("update-content (2)", async () => {
        ...
        await expect(async () => {
            return await client.components.updateContent("site_id", "component_id", {
                nodes: [
                    {
                        nodeId: "nodeId",
                        text: "text",
    ...
    test("get-properties (2)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/sites/site_id/components/component_id/properties")
            .respondWith()
            .statusCode(400)
            .jsonBody(rawResponseBody)
            .build();
        ...
        await expect(async () => {
            return await client.components.getProperties("site_id", "component_id");
        }).rejects.toThrow(Webflow.BadRequestError);
    });

    test("get-properties (3)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
    ...
    test("update-properties (1)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
    ...
    test("update-properties (2)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
        ...
        const rawRequestBody = {
            properties: [
                { propertyId: "propertyId", text: "text" },
                { propertyId: "propertyId", text: "text" },
            ],
        };
        const rawResponseBody = { key: "value" };
        ...
        await expect(async () => {
            return await client.components.updateProperties("site_id", "component_id", {
                properties: [
                    {
    ...
    test("update-properties (3)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
    ...
    test("update-properties (4)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
    ...
    test("update-properties (5)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
    ...
    test("update-properties (6)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },

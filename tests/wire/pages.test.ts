...
describe("Pages", () => {
    ...
    test("list (2)", async () => {
        ...
        await expect(async () => {
            return await client.pages.list("site_id");
    ...
    test("get-metadata (2)", async () => {
        ...
        const rawResponseBody = { key: "value" };
        server.mockEndpoint().get("/pages/page_id").respondWith().statusCode(400).jsonBody(rawResponseBody).build();

        await expect(async () => {
            return await client.pages.getMetadata("page_id");
        }).rejects.toThrow(Webflow.BadRequestError);
    });

    test("get-metadata (3)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
        ...
        const rawResponseBody = {};
        server.mockEndpoint().get("/pages/page_id").respondWith().statusCode(401).jsonBody(rawResponseBody).build();
    ...
    test("get-metadata (4)", async () => {
        ...
        const rawResponseBody = {};
        server.mockEndpoint().get("/pages/page_id").respondWith().statusCode(404).jsonBody(rawResponseBody).build();
    ...
    test("get-metadata (5)", async () => {
        ...
        const rawResponseBody = {};
        server.mockEndpoint().get("/pages/page_id").respondWith().statusCode(429).jsonBody(rawResponseBody).build();
    ...
    test("get-metadata (6)", async () => {
        ...
        const rawResponseBody = {};
        server.mockEndpoint().get("/pages/page_id").respondWith().statusCode(500).jsonBody(rawResponseBody).build();
    ...
    test("update-page-settings (1)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
    ...
    test("update-page-settings (2)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
        ...
        await expect(async () => {
            return await client.pages.updatePageSettings("page_id");
        }).rejects.toThrow(Webflow.BadRequestError);
    });

    test("update-page-settings (3)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
    ...
    test("update-page-settings (4)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
    ...
    test("update-page-settings (5)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
    ...
    test("update-page-settings (6)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
    ...
    test("get-content (1)", async () => {
        ...
        const rawResponseBody = {
            ...
            nodes: [
                ...
                { type: "text", id: "id", text: {}, attributes: { key: "value" } },
                { type: "image", id: "id", image: {}, attributes: { key: "value" } },
                { type: "select", id: "id", choices: [{ value: "value", text: "text" }], attributes: { key: "value" } },
                { type: "text-input", id: "id", placeholder: "placeholder", attributes: { key: "value" } },
                { type: "text", id: "id", text: {}, attributes: { key: "value" } },
                {
    ...
    test("get-content (2)", async () => {
        ...
        const rawResponseBody = { key: "value" };
        server.mockEndpoint().get("/pages/page_id/dom").respondWith().statusCode(400).jsonBody(rawResponseBody).build();

        await expect(async () => {
            return await client.pages.getContent("page_id");
        }).rejects.toThrow(Webflow.BadRequestError);
    });

    test("get-content (3)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
        ...
        const rawResponseBody = {};
        server.mockEndpoint().get("/pages/page_id/dom").respondWith().statusCode(401).jsonBody(rawResponseBody).build();
    ...
    test("get-content (4)", async () => {
        ...
        const rawResponseBody = { key: "value" };
        server.mockEndpoint().get("/pages/page_id/dom").respondWith().statusCode(403).jsonBody(rawResponseBody).build();
    ...
    test("get-content (5)", async () => {
        ...
        const rawResponseBody = {};
        server.mockEndpoint().get("/pages/page_id/dom").respondWith().statusCode(404).jsonBody(rawResponseBody).build();
    ...
    test("get-content (6)", async () => {
        ...
        const rawResponseBody = {};
        server.mockEndpoint().get("/pages/page_id/dom").respondWith().statusCode(429).jsonBody(rawResponseBody).build();
    ...
    test("get-content (7)", async () => {
        ...
        const rawResponseBody = {};
        server.mockEndpoint().get("/pages/page_id/dom").respondWith().statusCode(500).jsonBody(rawResponseBody).build();
    ...
    test("update-static-content (1)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
    ...
    test("update-static-content (2)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
        ...
        await expect(async () => {
            return await client.pages.updateStaticContent("page_id", {
                localeId: "localeId",
                nodes: [
                    {
                        nodeId: "nodeId",
    ...
    test("update-static-content (3)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
    ...
    test("update-static-content (4)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
    ...
    test("update-static-content (5)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
    ...
    test("update-static-content (6)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },
    ...
    test("update-static-content (7)", async () => {
        const server = mockServerPool.createServer();
        const client = new WebflowClient({
            accessToken: "test",
            environment: { base: server.baseUrl, dataApi: server.baseUrl, contentDeliveryApi: server.baseUrl },

 ...
 */
export interface EcommOrderChangedPayloadStripeCard {
    /** The last 4 digits on the card as a string */
    last4?: string;
    /** The card's brand (ie. credit card network) */
    brand?: Webflow.EcommOrderChangedPayloadStripeCardBrand;
    /** The name on the card. */
    ownerName?: string;
    /** The card's expiration date. */
    expires?: Webflow.EcommOrderChangedPayloadStripeCardExpires;
}

 ...
 * A customer address
 */
export interface OrdersUpdateResponseAllAddressesItem {
    /** The type of the order address (billing or shipping) */
    type?: Webflow.OrdersUpdateResponseAllAddressesItemType;
    /** Represents a Japan-only address format. This field will only appear on orders placed from Japan. */
    japanType?: Webflow.OrdersUpdateResponseAllAddressesItemJapanType;

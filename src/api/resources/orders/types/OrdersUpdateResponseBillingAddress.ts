 ...
 * The billing address
 */
export interface OrdersUpdateResponseBillingAddress {
    /** The type of the order address (billing or shipping) */
    type?: Webflow.OrdersUpdateResponseBillingAddressType;
    /** Represents a Japan-only address format. This field will only appear on orders placed from Japan. */
    japanType?: Webflow.OrdersUpdateResponseBillingAddressJapanType;

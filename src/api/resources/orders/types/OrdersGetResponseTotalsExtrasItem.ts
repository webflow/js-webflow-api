 ...
 */
export interface OrdersGetResponseTotalsExtrasItem {
    /** The type of extra item this is. */
    type?: Webflow.OrdersGetResponseTotalsExtrasItemType;
    /** A human-readable (but English) name for this extra charge. */
    name?: string;
    /** A human-readable (but English) description of this extra charge. */
    description?: string;
    /** The price for the item */
    price?: Webflow.OrdersGetResponseTotalsExtrasItemPrice;
}

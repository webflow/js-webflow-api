 ...
 */
export interface OrdersUpdateUnfulfillResponsePurchasedItemsItem {
    /** Number of Item purchased. */
    count?: number;
    /** The total for the row */
    rowTotal?: Webflow.OrdersUpdateUnfulfillResponsePurchasedItemsItemRowTotal;
    ...
    variantSku?: string;
    variantImage?: Webflow.OrdersUpdateUnfulfillResponsePurchasedItemsItemVariantImage;
    /** The price corresponding to the variant */
    variantPrice?: Webflow.OrdersUpdateUnfulfillResponsePurchasedItemsItemVariantPrice;

...
export interface EcommOrderChangedPayload {
    /**
    ...
    status?: Webflow.EcommOrderChangedPayloadStatus;
    ...
    disputeLastStatus?: Webflow.EcommOrderChangedPayloadDisputeLastStatus;
    /** The total paid by the customer */
    customerPaid?: Webflow.EcommOrderChangedPayloadCustomerPaid;
    /** The net amount after application fees */
    netAmount?: Webflow.EcommOrderChangedPayloadNetAmount;
    /** The application fee assessed by the platform */
    applicationFee?: Webflow.EcommOrderChangedPayloadApplicationFee;
    /** All addresses provided by the customer during the ordering flow. */
    allAddresses?: Webflow.EcommOrderChangedPayloadAllAddressesItem[];
    /** The shipping address */
    shippingAddress?: Webflow.EcommOrderChangedPayloadShippingAddress;
    /** The billing address */
    billingAddress?: Webflow.EcommOrderChangedPayloadBillingAddress;
    ...
    customerInfo?: Webflow.EcommOrderChangedPayloadCustomerInfo;
    /** An array of all things that the Customer purchased. */
    purchasedItems?: Webflow.EcommOrderChangedPayloadPurchasedItemsItem[];
    ...
    stripeDetails?: Webflow.EcommOrderChangedPayloadStripeDetails;
    /** Details on the card used to fulfill this order, if this order was finalized with Stripe. */
    stripeCard?: Webflow.EcommOrderChangedPayloadStripeCard;
    paypalDetails?: Webflow.EcommOrderChangedPayloadPaypalDetails;
    ...
    metadata?: Webflow.EcommOrderChangedPayloadMetadata;
    ...
    totals?: Webflow.EcommOrderChangedPayloadTotals;
    /** An array of downloadable file objects. */
    downloadFiles?: Webflow.EcommOrderChangedPayloadDownloadFilesItem[];
}

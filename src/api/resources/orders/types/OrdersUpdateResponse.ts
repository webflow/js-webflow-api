...
export interface OrdersUpdateResponse {
    ...
    status?: Webflow.OrdersUpdateResponseStatus;
    ...
    disputeLastStatus?: Webflow.OrdersUpdateResponseDisputeLastStatus;
    /** The total paid by the customer */
    customerPaid?: Webflow.OrdersUpdateResponseCustomerPaid;
    /** The net amount after application fees */
    netAmount?: Webflow.OrdersUpdateResponseNetAmount;
    /** The application fee assessed by the platform */
    applicationFee?: Webflow.OrdersUpdateResponseApplicationFee;
    /** All addresses provided by the customer during the ordering flow. */
    allAddresses?: Webflow.OrdersUpdateResponseAllAddressesItem[];
    /** The shipping address */
    shippingAddress?: Webflow.OrdersUpdateResponseShippingAddress;
    /** The billing address */
    billingAddress?: Webflow.OrdersUpdateResponseBillingAddress;
    ...
    customerInfo?: Webflow.OrdersUpdateResponseCustomerInfo;
    /** An array of all things that the Customer purchased. */
    purchasedItems?: Webflow.OrdersUpdateResponsePurchasedItemsItem[];
    ...
    stripeDetails?: Webflow.OrdersUpdateResponseStripeDetails;
    /** Details on the card used to fulfill this order, if this order was finalized with Stripe. */
    stripeCard?: Webflow.OrdersUpdateResponseStripeCard;
    paypalDetails?: Webflow.OrdersUpdateResponsePaypalDetails;
    ...
    metadata?: Webflow.OrdersUpdateResponseMetadata;
    ...
    totals?: Webflow.OrdersUpdateResponseTotals;
    /** An array of downloadable file objects. */
    downloadFiles?: Webflow.OrdersUpdateResponseDownloadFilesItem[];
}

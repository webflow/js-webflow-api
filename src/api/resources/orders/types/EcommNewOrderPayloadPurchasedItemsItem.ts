 ...
 */
export interface EcommNewOrderPayloadPurchasedItemsItem {
    /** Number of Item purchased. */
    count?: number;
    /** The total for the row */
    rowTotal?: Webflow.EcommNewOrderPayloadPurchasedItemsItemRowTotal;
    ...
    variantSku?: string;
    variantImage?: Webflow.EcommNewOrderPayloadPurchasedItemsItemVariantImage;
    /** The price corresponding to the variant */
    variantPrice?: Webflow.EcommNewOrderPayloadPurchasedItemsItemVariantPrice;

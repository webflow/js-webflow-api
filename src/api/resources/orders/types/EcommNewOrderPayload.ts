...
export interface EcommNewOrderPayload {
    /**
    ...
    status?: Webflow.EcommNewOrderPayloadStatus;
    ...
    disputeLastStatus?: Webflow.EcommNewOrderPayloadDisputeLastStatus;
    /** The total paid by the customer */
    customerPaid?: Webflow.EcommNewOrderPayloadCustomerPaid;
    /** The net amount after application fees */
    netAmount?: Webflow.EcommNewOrderPayloadNetAmount;
    /** The application fee assessed by the platform */
    applicationFee?: Webflow.EcommNewOrderPayloadApplicationFee;
    /** All addresses provided by the customer during the ordering flow. */
    allAddresses?: Webflow.EcommNewOrderPayloadAllAddressesItem[];
    /** The shipping address */
    shippingAddress?: Webflow.EcommNewOrderPayloadShippingAddress;
    /** The billing address */
    billingAddress?: Webflow.EcommNewOrderPayloadBillingAddress;
    ...
    customerInfo?: Webflow.EcommNewOrderPayloadCustomerInfo;
    /** An array of all things that the Customer purchased. */
    purchasedItems?: Webflow.EcommNewOrderPayloadPurchasedItemsItem[];
    ...
    stripeDetails?: Webflow.EcommNewOrderPayloadStripeDetails;
    /** Details on the card used to fulfill this order, if this order was finalized with Stripe. */
    stripeCard?: Webflow.EcommNewOrderPayloadStripeCard;
    paypalDetails?: Webflow.EcommNewOrderPayloadPaypalDetails;
    ...
    metadata?: Webflow.EcommNewOrderPayloadMetadata;
    ...
    totals?: Webflow.EcommNewOrderPayloadTotals;
    /** An array of downloadable file objects. */
    downloadFiles?: Webflow.EcommNewOrderPayloadDownloadFilesItem[];
}

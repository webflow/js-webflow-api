...
export interface OrdersUpdateUnfulfillResponse {
    /**
    ...
    status?: Webflow.OrdersUpdateUnfulfillResponseStatus;
    ...
    disputeLastStatus?: Webflow.OrdersUpdateUnfulfillResponseDisputeLastStatus;
    /** The total paid by the customer */
    customerPaid?: Webflow.OrdersUpdateUnfulfillResponseCustomerPaid;
    /** The net amount after application fees */
    netAmount?: Webflow.OrdersUpdateUnfulfillResponseNetAmount;
    /** The application fee assessed by the platform */
    applicationFee?: Webflow.OrdersUpdateUnfulfillResponseApplicationFee;
    /** All addresses provided by the customer during the ordering flow. */
    allAddresses?: Webflow.OrdersUpdateUnfulfillResponseAllAddressesItem[];
    /** The shipping address */
    shippingAddress?: Webflow.OrdersUpdateUnfulfillResponseShippingAddress;
    /** The billing address */
    billingAddress?: Webflow.OrdersUpdateUnfulfillResponseBillingAddress;
    ...
    customerInfo?: Webflow.OrdersUpdateUnfulfillResponseCustomerInfo;
    /** An array of all things that the Customer purchased. */
    purchasedItems?: Webflow.OrdersUpdateUnfulfillResponsePurchasedItemsItem[];
    ...
    stripeDetails?: Webflow.OrdersUpdateUnfulfillResponseStripeDetails;
    /** Details on the card used to fulfill this order, if this order was finalized with Stripe. */
    stripeCard?: Webflow.OrdersUpdateUnfulfillResponseStripeCard;
    paypalDetails?: Webflow.OrdersUpdateUnfulfillResponsePaypalDetails;
    ...
    metadata?: Webflow.OrdersUpdateUnfulfillResponseMetadata;
    ...
    totals?: Webflow.OrdersUpdateUnfulfillResponseTotals;
    /** An array of downloadable file objects. */
    downloadFiles?: Webflow.OrdersUpdateUnfulfillResponseDownloadFilesItem[];
}

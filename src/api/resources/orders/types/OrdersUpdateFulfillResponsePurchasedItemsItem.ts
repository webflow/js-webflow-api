 ...
 */
export interface OrdersUpdateFulfillResponsePurchasedItemsItem {
    /** Number of Item purchased. */
    count?: number;
    /** The total for the row */
    rowTotal?: Webflow.OrdersUpdateFulfillResponsePurchasedItemsItemRowTotal;
    ...
    variantSku?: string;
    variantImage?: Webflow.OrdersUpdateFulfillResponsePurchasedItemsItemVariantImage;
    /** The price corresponding to the variant */
    variantPrice?: Webflow.OrdersUpdateFulfillResponsePurchasedItemsItemVariantPrice;

 ...
 */
export interface OrdersGetResponsePurchasedItemsItem {
    /** Number of Item purchased. */
    count?: number;
    /** The total for the row */
    rowTotal?: Webflow.OrdersGetResponsePurchasedItemsItemRowTotal;
    ...
    variantSku?: string;
    variantImage?: Webflow.OrdersGetResponsePurchasedItemsItemVariantImage;
    /** The price corresponding to the variant */
    variantPrice?: Webflow.OrdersGetResponsePurchasedItemsItemVariantPrice;

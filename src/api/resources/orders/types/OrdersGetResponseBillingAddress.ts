 ...
 * The billing address
 */
export interface OrdersGetResponseBillingAddress {
    /** The type of the order address (billing or shipping) */
    type?: Webflow.OrdersGetResponseBillingAddressType;
    /** Represents a Japan-only address format. This field will only appear on orders placed from Japan. */
    japanType?: Webflow.OrdersGetResponseBillingAddressJapanType;

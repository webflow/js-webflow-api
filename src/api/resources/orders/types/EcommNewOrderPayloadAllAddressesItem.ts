 ...
 * A customer address
 */
export interface EcommNewOrderPayloadAllAddressesItem {
    /** The type of the order address (billing or shipping) */
    type?: Webflow.EcommNewOrderPayloadAllAddressesItemType;
    /** Represents a Japan-only address format. This field will only appear on orders placed from Japan. */
    japanType?: Webflow.EcommNewOrderPayloadAllAddressesItemJapanType;

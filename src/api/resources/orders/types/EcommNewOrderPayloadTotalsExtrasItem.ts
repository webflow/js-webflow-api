 ...
 */
export interface EcommNewOrderPayloadTotalsExtrasItem {
    /** The type of extra item this is. */
    type?: Webflow.EcommNewOrderPayloadTotalsExtrasItemType;
    /** A human-readable (but English) name for this extra charge. */
    name?: string;
    /** A human-readable (but English) description of this extra charge. */
    description?: string;
    /** The price for the item */
    price?: Webflow.EcommNewOrderPayloadTotalsExtrasItemPrice;
}

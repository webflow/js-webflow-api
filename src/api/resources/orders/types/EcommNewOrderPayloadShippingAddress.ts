 ...
 */
export interface EcommNewOrderPayloadShippingAddress {
    /** The type of the order address (billing or shipping) */
    type?: Webflow.EcommNewOrderPayloadShippingAddressType;
    /** Represents a Japan-only address format. This field will only appear on orders placed from Japan. */
    japanType?: Webflow.EcommNewOrderPayloadShippingAddressJapanType;

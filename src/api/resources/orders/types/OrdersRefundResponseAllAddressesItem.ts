 ...
 * A customer address
 */
export interface OrdersRefundResponseAllAddressesItem {
    /** The type of the order address (billing or shipping) */
    type?: Webflow.OrdersRefundResponseAllAddressesItemType;
    /** Represents a Japan-only address format. This field will only appear on orders placed from Japan. */
    japanType?: Webflow.OrdersRefundResponseAllAddressesItemJapanType;

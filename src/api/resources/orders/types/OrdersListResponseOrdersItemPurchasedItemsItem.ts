 ...
 */
export interface OrdersListResponseOrdersItemPurchasedItemsItem {
    /** Number of Item purchased. */
    count?: number;
    /** The total for the row */
    rowTotal?: Webflow.OrdersListResponseOrdersItemPurchasedItemsItemRowTotal;
    ...
    variantSku?: string;
    variantImage?: Webflow.OrdersListResponseOrdersItemPurchasedItemsItemVariantImage;
    /** The price corresponding to the variant */
    variantPrice?: Webflow.OrdersListResponseOrdersItemPurchasedItemsItemVariantPrice;

 ...
 * The billing address
 */
export interface EcommNewOrderPayloadBillingAddress {
    /** The type of the order address (billing or shipping) */
    type?: Webflow.EcommNewOrderPayloadBillingAddressType;
    /** Represents a Japan-only address format. This field will only appear on orders placed from Japan. */
    japanType?: Webflow.EcommNewOrderPayloadBillingAddressJapanType;

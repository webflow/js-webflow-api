...
export interface OrdersGetResponse {
    ...
    status?: Webflow.OrdersGetResponseStatus;
    ...
    disputeLastStatus?: Webflow.OrdersGetResponseDisputeLastStatus;
    /** The total paid by the customer */
    customerPaid?: Webflow.OrdersGetResponseCustomerPaid;
    /** The net amount after application fees */
    netAmount?: Webflow.OrdersGetResponseNetAmount;
    /** The application fee assessed by the platform */
    applicationFee?: Webflow.OrdersGetResponseApplicationFee;
    /** All addresses provided by the customer during the ordering flow. */
    allAddresses?: Webflow.OrdersGetResponseAllAddressesItem[];
    /** The shipping address */
    shippingAddress?: Webflow.OrdersGetResponseShippingAddress;
    /** The billing address */
    billingAddress?: Webflow.OrdersGetResponseBillingAddress;
    ...
    customerInfo?: Webflow.OrdersGetResponseCustomerInfo;
    /** An array of all things that the Customer purchased. */
    purchasedItems?: Webflow.OrdersGetResponsePurchasedItemsItem[];
    ...
    stripeDetails?: Webflow.OrdersGetResponseStripeDetails;
    /** Details on the card used to fulfill this order, if this order was finalized with Stripe. */
    stripeCard?: Webflow.OrdersGetResponseStripeCard;
    paypalDetails?: Webflow.OrdersGetResponsePaypalDetails;
    ...
    metadata?: Webflow.OrdersGetResponseMetadata;
    ...
    totals?: Webflow.OrdersGetResponseTotals;
    /** An array of downloadable file objects. */
    downloadFiles?: Webflow.OrdersGetResponseDownloadFilesItem[];
}

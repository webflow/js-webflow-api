...
export interface OrdersUpdateFulfillResponse {
    /**
    ...
    status?: Webflow.OrdersUpdateFulfillResponseStatus;
    ...
    disputeLastStatus?: Webflow.OrdersUpdateFulfillResponseDisputeLastStatus;
    /** The total paid by the customer */
    customerPaid?: Webflow.OrdersUpdateFulfillResponseCustomerPaid;
    /** The net amount after application fees */
    netAmount?: Webflow.OrdersUpdateFulfillResponseNetAmount;
    /** The application fee assessed by the platform */
    applicationFee?: Webflow.OrdersUpdateFulfillResponseApplicationFee;
    /** All addresses provided by the customer during the ordering flow. */
    allAddresses?: Webflow.OrdersUpdateFulfillResponseAllAddressesItem[];
    /** The shipping address */
    shippingAddress?: Webflow.OrdersUpdateFulfillResponseShippingAddress;
    /** The billing address */
    billingAddress?: Webflow.OrdersUpdateFulfillResponseBillingAddress;
    ...
    customerInfo?: Webflow.OrdersUpdateFulfillResponseCustomerInfo;
    /** An array of all things that the Customer purchased. */
    purchasedItems?: Webflow.OrdersUpdateFulfillResponsePurchasedItemsItem[];
    ...
    stripeDetails?: Webflow.OrdersUpdateFulfillResponseStripeDetails;
    /** Details on the card used to fulfill this order, if this order was finalized with Stripe. */
    stripeCard?: Webflow.OrdersUpdateFulfillResponseStripeCard;
    paypalDetails?: Webflow.OrdersUpdateFulfillResponsePaypalDetails;
    ...
    metadata?: Webflow.OrdersUpdateFulfillResponseMetadata;
    ...
    totals?: Webflow.OrdersUpdateFulfillResponseTotals;
    /** An array of downloadable file objects. */
    downloadFiles?: Webflow.OrdersUpdateFulfillResponseDownloadFilesItem[];
}

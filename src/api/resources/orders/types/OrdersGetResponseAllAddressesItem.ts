 ...
 * A customer address
 */
export interface OrdersGetResponseAllAddressesItem {
    /** The type of the order address (billing or shipping) */
    type?: Webflow.OrdersGetResponseAllAddressesItemType;
    /** Represents a Japan-only address format. This field will only appear on orders placed from Japan. */
    japanType?: Webflow.OrdersGetResponseAllAddressesItemJapanType;

 ...
 */
export interface OrdersUpdateResponsePurchasedItemsItem {
    /** Number of Item purchased. */
    count?: number;
    /** The total for the row */
    rowTotal?: Webflow.OrdersUpdateResponsePurchasedItemsItemRowTotal;
    ...
    variantSku?: string;
    variantImage?: Webflow.OrdersUpdateResponsePurchasedItemsItemVariantImage;
    /** The price corresponding to the variant */
    variantPrice?: Webflow.OrdersUpdateResponsePurchasedItemsItemVariantPrice;

...
export class Scripts {
    ...
    public async getCustomCode(
    ...
    ): Promise<Webflow.pages.ScriptsGetCustomCodeResponse> {
        ...
        if (_response.ok) {
            return serializers.pages.ScriptsGetCustomCodeResponse.parseOrThrow(_response.body, {
     ...
     *
     * @param {string} pageId - Unique identifier for a Page
     * @param {Webflow.pages.ScriptsUpsertCustomCodeRequest} request
     * @param {Scripts.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Webflow.BadRequestError}
     * @throws {@link Webflow.UnauthorizedError}
    ...
    public async upsertCustomCode(
        ...
        requestOptions?: Scripts.RequestOptions
    ): Promise<Webflow.pages.ScriptsUpsertCustomCodeResponse> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.WebflowEnvironment.Default,
                `pages/${encodeURIComponent(pageId)}/custom_code`
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.pages.ScriptsUpsertCustomCodeRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return serializers.pages.ScriptsUpsertCustomCodeResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,

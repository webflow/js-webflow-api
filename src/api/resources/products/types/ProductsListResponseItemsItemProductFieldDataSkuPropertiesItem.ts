 ...
 */
export interface ProductsListResponseItemsItemProductFieldDataSkuPropertiesItem {
    ...
    enum: Webflow.ProductsListResponseItemsItemProductFieldDataSkuPropertiesItemEnumItem[];
}

 ...
 */
export interface ProductsGetResponseProductFieldData {
    /** Name of the Product */
    name?: string;
    ...
    skuProperties?: Webflow.ProductsGetResponseProductFieldDataSkuPropertiesItem[];
    /** The categories your product belongs to. */
    categories?: string[];
    /** Product tax class */
    taxCategory?: Webflow.ProductsGetResponseProductFieldDataTaxCategory;
    ...
    ecProductType?: Webflow.ProductsGetResponseProductFieldDataEcProductType;
}

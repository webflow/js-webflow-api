 ...
 */
export interface ProductsListResponseItemsItemProductFieldData {
    /** Name of the Product */
    name?: string;
    ...
    skuProperties?: Webflow.ProductsListResponseItemsItemProductFieldDataSkuPropertiesItem[];
    /** The categories your product belongs to. */
    categories?: string[];
    /** Product tax class */
    taxCategory?: Webflow.ProductsListResponseItemsItemProductFieldDataTaxCategory;
    ...
    ecProductType?: Webflow.ProductsListResponseItemsItemProductFieldDataEcProductType;
}

...
export class WellKnown {
     ...
     * @param {Webflow.WellKnownFile} request
    ...
    public async put(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.WellKnownFile.jsonOrThrow(request, {
     ...
     *
     * @param {string} siteId - Unique identifier for a Site
     * @param {Webflow.WellKnownDeleteRequest} request
     * @param {WellKnown.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Webflow.BadRequestError}
     * @throws {@link Webflow.UnauthorizedError}
    ...
    public async delete(
        ...
        const _response = await core.fetcher({
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.WellKnownDeleteRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
            }),

...
export declare namespace WellKnownClient {
...
export class WellKnownClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<WellKnownClient.Options>;

    constructor(options: WellKnownClient.Options) {
     ...
     * @param {WellKnownClient.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    private async __put(
            ...
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    ((await core.Supplier.get(this._options.environment)) ?? environments.WebflowEnvironment.DataApi)
                        .base,
                `sites/${core.url.encodePathParam(site_id)}/well_known`,
            ),
            method: "PUT",
            headers: _headers,
            contentType: "application/json",
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "PUT", "/sites/{site_id}/well_known");
    }

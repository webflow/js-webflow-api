...
export interface ScriptsListCustomCodeBlocksResponseBlocksItemScriptsItem {
    /** ID of the registered custom code script */
    id: string;
    /** Location of the script, either in the header or footer of the published site */
    location: Webflow.sites.ScriptsListCustomCodeBlocksResponseBlocksItemScriptsItemLocation;

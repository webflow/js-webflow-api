...
export class Scripts {
    ...
    public async getCustomCode(
    ...
    ): Promise<Webflow.sites.ScriptsGetCustomCodeResponse> {
        ...
        if (_response.ok) {
            return serializers.sites.ScriptsGetCustomCodeResponse.parseOrThrow(_response.body, {
     ...
     *
     * @param {string} siteId - Unique identifier for a Site
     * @param {Webflow.sites.ScriptsUpsertCustomCodeRequest} request
     * @param {Scripts.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Webflow.BadRequestError}
     * @throws {@link Webflow.UnauthorizedError}
    ...
    public async upsertCustomCode(
        ...
        requestOptions?: Scripts.RequestOptions
    ): Promise<Webflow.sites.ScriptsUpsertCustomCodeResponse> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.WebflowEnvironment.Default,
                `sites/${encodeURIComponent(siteId)}/custom_code`
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.sites.ScriptsUpsertCustomCodeRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return serializers.sites.ScriptsUpsertCustomCodeResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
    ...
    public async listCustomCodeBlocks(
        ...
        requestOptions?: Scripts.RequestOptions
    ): Promise<Webflow.sites.ScriptsListCustomCodeBlocksResponse> {
        ...
        if (_response.ok) {
            return serializers.sites.ScriptsListCustomCodeBlocksResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,

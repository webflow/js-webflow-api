...
export const AssetsCreateResponseUploadDetails: core.serialization.ObjectSchema<
    serializers.AssetsCreateResponseUploadDetails.Raw,
    Webflow.AssetsCreateResponseUploadDetails

...
export const AssetsGetResponseVariantsItem: core.serialization.ObjectSchema<
    serializers.AssetsGetResponseVariantsItem.Raw,
    Webflow.AssetsGetResponseVariantsItem

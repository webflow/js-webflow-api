...
export const OrdersUpdateUnfulfillResponseStripeDetails: core.serialization.ObjectSchema<
    serializers.OrdersUpdateUnfulfillResponseStripeDetails.Raw,
    Webflow.OrdersUpdateUnfulfillResponseStripeDetails
...
export declare namespace OrdersUpdateUnfulfillResponseStripeDetails {
    interface Raw {

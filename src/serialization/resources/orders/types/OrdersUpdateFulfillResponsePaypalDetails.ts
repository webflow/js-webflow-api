...
export const OrdersUpdateFulfillResponsePaypalDetails: core.serialization.ObjectSchema<
    serializers.OrdersUpdateFulfillResponsePaypalDetails.Raw,
    Webflow.OrdersUpdateFulfillResponsePaypalDetails
...
export declare namespace OrdersUpdateFulfillResponsePaypalDetails {
    interface Raw {
        orderId?: string | null;
        payerId?: string | null;

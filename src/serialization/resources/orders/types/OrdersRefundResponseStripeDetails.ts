...
export const OrdersRefundResponseStripeDetails: core.serialization.ObjectSchema<
    serializers.OrdersRefundResponseStripeDetails.Raw,
    Webflow.OrdersRefundResponseStripeDetails
...
export declare namespace OrdersRefundResponseStripeDetails {
    interface Raw {

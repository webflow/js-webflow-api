...
export const EcommOrderChangedPayloadPaypalDetails: core.serialization.ObjectSchema<
    serializers.EcommOrderChangedPayloadPaypalDetails.Raw,
    Webflow.EcommOrderChangedPayloadPaypalDetails
...
export declare namespace EcommOrderChangedPayloadPaypalDetails {
    interface Raw {
        orderId?: string | null;
        payerId?: string | null;

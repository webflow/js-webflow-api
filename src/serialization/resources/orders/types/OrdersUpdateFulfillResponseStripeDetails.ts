...
export const OrdersUpdateFulfillResponseStripeDetails: core.serialization.ObjectSchema<
    serializers.OrdersUpdateFulfillResponseStripeDetails.Raw,
    Webflow.OrdersUpdateFulfillResponseStripeDetails

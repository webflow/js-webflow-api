...
export const OrdersListResponseOrdersItemStripeDetails: core.serialization.ObjectSchema<
    serializers.OrdersListResponseOrdersItemStripeDetails.Raw,
    Webflow.OrdersListResponseOrdersItemStripeDetails
...
export declare namespace OrdersListResponseOrdersItemStripeDetails {
    interface Raw {

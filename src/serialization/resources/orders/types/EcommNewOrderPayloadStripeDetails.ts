...
export const EcommNewOrderPayloadStripeDetails: core.serialization.ObjectSchema<
    serializers.EcommNewOrderPayloadStripeDetails.Raw,
    Webflow.EcommNewOrderPayloadStripeDetails
...
export declare namespace EcommNewOrderPayloadStripeDetails {
    interface Raw {

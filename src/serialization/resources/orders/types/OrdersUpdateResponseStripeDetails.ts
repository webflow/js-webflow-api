...
export const OrdersUpdateResponseStripeDetails: core.serialization.ObjectSchema<
    serializers.OrdersUpdateResponseStripeDetails.Raw,
    Webflow.OrdersUpdateResponseStripeDetails

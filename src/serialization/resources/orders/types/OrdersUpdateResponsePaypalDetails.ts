...
export const OrdersUpdateResponsePaypalDetails: core.serialization.ObjectSchema<
    serializers.OrdersUpdateResponsePaypalDetails.Raw,
    Webflow.OrdersUpdateResponsePaypalDetails
...
export declare namespace OrdersUpdateResponsePaypalDetails {
    interface Raw {
        orderId?: string | null;
        payerId?: string | null;

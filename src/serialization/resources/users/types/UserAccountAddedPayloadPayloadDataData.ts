...
export const UserAccountAddedPayloadPayloadDataData: core.serialization.ObjectSchema<
    serializers.UserAccountAddedPayloadPayloadDataData.Raw,
    Webflow.UserAccountAddedPayloadPayloadDataData

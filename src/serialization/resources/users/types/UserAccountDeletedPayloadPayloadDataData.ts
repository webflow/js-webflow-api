...
export const UserAccountDeletedPayloadPayloadDataData: core.serialization.ObjectSchema<
    serializers.UserAccountDeletedPayloadPayloadDataData.Raw,
    Webflow.UserAccountDeletedPayloadPayloadDataData

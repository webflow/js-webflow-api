...
export const UsersGetResponseDataData: core.serialization.ObjectSchema<
    serializers.UsersGetResponseDataData.Raw,
    Webflow.UsersGetResponseDataData
...
export declare namespace UsersGetResponseDataData {
    interface Raw {
        name?: string | null;
        email?: string | null;

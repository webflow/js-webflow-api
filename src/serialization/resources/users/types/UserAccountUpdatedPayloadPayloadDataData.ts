...
export const UserAccountUpdatedPayloadPayloadDataData: core.serialization.ObjectSchema<
    serializers.UserAccountUpdatedPayloadPayloadDataData.Raw,
    Webflow.UserAccountUpdatedPayloadPayloadDataData

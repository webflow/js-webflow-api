...
export const UsersListResponseUsersItemDataData: core.serialization.ObjectSchema<
    serializers.UsersListResponseUsersItemDataData.Raw,
    Webflow.UsersListResponseUsersItemDataData

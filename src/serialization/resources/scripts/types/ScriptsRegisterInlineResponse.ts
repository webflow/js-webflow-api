...
export const ScriptsRegisterInlineResponse: core.serialization.ObjectSchema<
    serializers.ScriptsRegisterInlineResponse.Raw,
    Webflow.ScriptsRegisterInlineResponse
...
export declare namespace ScriptsRegisterInlineResponse {
    interface Raw {
        id?: string | null;

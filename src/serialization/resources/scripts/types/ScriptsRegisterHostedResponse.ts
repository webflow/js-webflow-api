...
export const ScriptsRegisterHostedResponse: core.serialization.ObjectSchema<
    serializers.ScriptsRegisterHostedResponse.Raw,
    Webflow.ScriptsRegisterHostedResponse

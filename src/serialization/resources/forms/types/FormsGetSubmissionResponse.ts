...
export const FormsGetSubmissionResponse: core.serialization.ObjectSchema<
    serializers.FormsGetSubmissionResponse.Raw,
    Webflow.FormsGetSubmissionResponse
...
export declare namespace FormsGetSubmissionResponse {
    interface Raw {
        id?: string | null;

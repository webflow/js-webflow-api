...
export const FormsListResponseFormsItemResponseSettings: core.serialization.ObjectSchema<
    serializers.FormsListResponseFormsItemResponseSettings.Raw,
    Webflow.FormsListResponseFormsItemResponseSettings
...
export declare namespace FormsListResponseFormsItemResponseSettings {
    interface Raw {

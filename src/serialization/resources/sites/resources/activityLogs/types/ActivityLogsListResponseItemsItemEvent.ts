...
export const ActivityLogsListResponseItemsItemEvent: core.serialization.Schema<
    serializers.sites.ActivityLogsListResponseItemsItemEvent.Raw,
    Webflow.sites.ActivityLogsListResponseItemsItemEvent
...
export declare namespace ActivityLogsListResponseItemsItemEvent {
    type Raw =
        | "styles_modified"
        | "site_published"
        | "ix2_modified_on_page"

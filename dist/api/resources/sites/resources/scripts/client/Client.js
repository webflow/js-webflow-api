...
class Scripts {
    ...
    getCustomCode(siteId, requestOptions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)((_a = (yield core.Supplier.get(this._options.environment))) !== null && _a !== void 0 ? _a : environments.WebflowEnvironment.Default, `v2/sites/${siteId}/custom_code`),
                method: "GET",
                headers: {
    ...
    listCustomCodeBlocks(siteId, request = {}, requestOptions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)((_a = (yield core.Supplier.get(this._options.environment))) !== null && _a !== void 0 ? _a : environments.WebflowEnvironment.Default, `v2/sites/${siteId}/custom_code/blocks`),
                method: "GET",
                headers: {
                    Authorization: yield this._getAuthorizationHeader(),
                    "X-Fern-Language": "JavaScript",

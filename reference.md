...
<details><summary><code>client.sitePlan.<a href="/src/api/resources/sitePlan/client/Client.ts">get</a>(siteId) -> Webflow.SitePlan</code></summary>
<dl>
<dd>
...
```typescript
await client.sitePlan.get("580e63e98c9a982ac9b8b741");
```

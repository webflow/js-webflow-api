...
<details><summary><code>client.robotsTxt.<a href="/src/api/resources/robotsTxt/client/Client.ts">get</a>(siteId) -> Webflow.Robots</code></summary>
<dl>
<dd>
...
```typescript
await client.robotsTxt.get("580e63e98c9a982ac9b8b741");
```
...
<details><summary><code>client.robotsTxt.<a href="/src/api/resources/robotsTxt/client/Client.ts">put</a>(siteId, { ...params }) -> Webflow.Robots</code></summary>
<dl>
<dd>
...
```typescript
await client.robotsTxt.put("580e63e98c9a982ac9b8b741", {
    rules: [
        {
            userAgent: "googlebot",
            allows: ["/public"],
...
<details><summary><code>client.robotsTxt.<a href="/src/api/resources/robotsTxt/client/Client.ts">delete</a>(siteId, { ...params }) -> Webflow.Robots</code></summary>
<dl>
<dd>
...
```typescript
await client.robotsTxt.delete("580e63e98c9a982ac9b8b741", {
    rules: [
        {
            userAgent: "*",
            allows: ["/public"],
...
<details><summary><code>client.robotsTxt.<a href="/src/api/resources/robotsTxt/client/Client.ts">patch</a>(siteId, { ...params }) -> Webflow.Robots</code></summary>
<dl>
<dd>
...
```typescript
await client.robotsTxt.patch("580e63e98c9a982ac9b8b741", {
    rules: [
        {
            userAgent: "googlebot",
            allows: ["/public"],
